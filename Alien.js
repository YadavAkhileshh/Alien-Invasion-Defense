  ...
  volumeSlider.addEventListener("input", function () {
    ...
    backgroundMusic.volume = volumeValue; // Set background music volume
  
    // Set the volume of all sound effects
    hitSound.volume = volumeValue;
    gunSound.volume = volumeValue;
  
    if (volumeValue == 0) {
      volumeIcon.classList.remove("fa-volume-up");
      volumeIcon.classList.add("fa-volume-mute");
      backgroundMusic.pause(); 
      hitSound.pause(); // Mute hit sound
      gunSound.pause(); // Mute gun sound
    } else {
  ...
  function shootBullet() {
    ...
    // Play the gun sound when a bullet is shot only if the volume is greater than 0
    if (volumeSlider.value > 0) {
  ...
  function startGame() {
    ...
    // Set the volume for sound effects at the start
    hitSound.volume = volumeSlider.value;
    gunSound.volume = volumeSlider.value;
